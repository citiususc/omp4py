...
Example using hybrid mode (1) and 2 threads: ``python3 main.py 1 fft 2 [ln2_max=22] [nits=10000] [seed=331]``
...
Example using hybrid mode (1) and 2 threads: ``python3 main.py 1 jacobi 2 [n=1000] [max_iter=1000] [tol=1e-6] [seed=0]``
...
Example using hybrid mode (1) and 2 threads: ``python3 main.py 1 lud 2 [n=1000] [seed=0]``
...
Example using hybrid mode (1) and 2 threads: ``python3 main.py 1 md 2 [n=2000] [steps=10] [seed=0]``
...
Example using hybrid mode (1) and 2 threads: ``python3 main.py 1 qsort 2 [n=40000000] [limit=100000]``
